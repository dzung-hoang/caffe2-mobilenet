...
op_root = "/home/nd/caffe2_set/caffe2/caffe2/"
dyndep.InitOpsLibrary(op_root + 'distributed:file_store_handler_ops')
...
def main():
    ...
    parser.add_argument("--train_data", type=str, default="/data/cifar10/train_minidb",
                        help="Path to training data or 'everstore_sampler'",
                        required=True)
    parser.add_argument("--test_data", type=str, default="/data/cifar10/test_minidb",
    ...
    parser.add_argument("--file_store_path", type=str, default="./models",
